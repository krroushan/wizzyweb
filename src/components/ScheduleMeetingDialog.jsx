// src/components/ScheduleMeetingDialog.jsx
"use client";
...
export function ScheduleMeetingDialog({ trigger }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => {
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-blue-600">
            Schedule a Meeting
          </DialogTitle>
        </DialogHeader>
